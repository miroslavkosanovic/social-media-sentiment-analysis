...
def real_time_dashboard(request):
    return render(request, 'dashboard/real_time_dashboard.html')
...
def data_analysis(request):
    ...
    return render(request, 'dashboard/data_analysis.html', context)
...
def protected_view(request):
    ...
    return render(request, 'dashboard/protected_view.html', context)